...
### ⑤ マイナー：収入は平年比を上回り、難易度は上がる見込み

* **収入**: Puell Multiple（＝マイナー収入の平年比）は9月6日時点で約**1.13**。30日前の0.83から価格の上昇に沿って戻し、8月末の1前後から一段上がりました。
* **設備**: ハッシュレートは約1,040 EH/sで30日で**+4.7%**、次回の難易度調整は**+2.0%前後**の見込みです。採算の改善に合わせて設備が戻っている形で、マイナー側からの売り圧が強まる局面ではありません。推奨手数料は1〜2 sat/vBと閑散のまま。

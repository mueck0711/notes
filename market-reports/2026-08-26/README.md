...
* **上乗せは縮んだ**: 直近の水準を年率に直した約+9.4%から、同じ期間で置ける短期金利（＝ドルを米国の短期国債で持つだけで受け取れる金利。13週Tビル、3.70%）を引いた上乗せは+5.7ポイント。直近34日の平均+3.2ポイントよりは厚いものの、前日の最大値+7.25ポイントからは縮みました。現物を持って先物を売る側の取り分が細り始めた、という意味です。これは「確実に取れる利回り」ではなく、短期金利に対する上乗せ、という意味の数字です。

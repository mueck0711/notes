...
* **上乗せは平年並みへ**: 直近の水準を年率に直した約+7.6%から、同じ期間で置ける短期金利（＝ドルを米国の短期国債で持つだけで受け取れる金利。13週Tビル、3.69%）を引いた上乗せは**+3.9ポイント**。前日の+5.7ポイントから縮み、直近34日の平均+3.2ポイントに近い水準まで戻りました。現物を持って先物を売る側の取り分は、急騰局面の厚さを失っています。これは「確実に取れる利回り」ではなく、短期金利に対する上乗せ、という意味の数字です。

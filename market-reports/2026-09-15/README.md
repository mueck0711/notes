...
IV（＝オプション価格から逆算した、この先の値動きの幅の予想）は実現ボラティリティ（＝直近30日に実際に起きた値動きの幅）より低く、市場はこの先の値動きを、過去の値動きより小さいと見ています。守りを固めている状態ではなく、怖がってもいません。FOMC（＝米国の金利を決める会合）の結果が出る17日の満期だけが一段高いのは、参加者が FOMC の直後の値動きにだけ値段を付けているためで、その先の満期には乗っていません。17日の満期は前日の39台から42まで上がり、参加者が FOMC の直後の値動きに見る幅は1日で広がりました。

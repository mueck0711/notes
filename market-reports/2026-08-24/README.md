...
* 年率（+11.0%）から短期金利（＝ドルを米国の短期国債で持つだけで受け取れる金利。13週Tビル 3.71%）を引いた**上乗せ分は+7.2ポイント**で、直近34日の平均（+2.6ポイント）を大きく超えています。現物を買って先物を売る形が、短期金利に対して割に合う場面が続いている、という意味です（確実に取れる利回りではなく、現物の保管・取引所リスク・証拠金の追加が前提になります）。
